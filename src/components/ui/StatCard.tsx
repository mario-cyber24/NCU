  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className={`p-2 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 text-primary-600 transition-colors duration-300 ${loading ? 'opacity-50' : ''}`}>
          {icon}
        </div>
      </div>
      
      <p className={`mt-4 font-bold ${valueSizeClasses[valueSize]} ${valueColor} transition-all duration-300 ${loading ? 'blur-sm' : ''}`}>
